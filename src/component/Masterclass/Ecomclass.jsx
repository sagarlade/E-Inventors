          ...
          <div className="row">
            <div className="col-md-8 mx-auto">
              ...
              <div className="ec_btn">
                <Link className="ec_b" to="/booking">
                  Book Now
                </Link>
              ...
              <div className="ec_desc mt-5 mb-5">
                ...
                <p className="desc_pq3">
                  In my E-commerce mentorship program I teach you the basics of
                  starting your own online business from start to finish. I go
                  over all subjects related to whatever it is you would like to
                  sell online from products to services. We go over business
                  licensing, domains, website development, marketing, and paid
                  advertising. Hope to schedule you soon for a in person class!
                </p>
              </div>
              <hr />

              <div className="ec_contact mt-4 mb-4">
                <h3 className="ec_cont">Contact Details</h3>
